<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main" style="background-color :cadetblue">
    <div class="row">
        <ol class="breadcrumb">
            <li><a href="#">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form"  data-toggle="validator" method="post" action="ajax.php">
                        ...
                        <button type="submit" class="btn btn-lg btn-success" name="createComplaintAdmin" style="border-radius:0%">Submit</button>
