...
?>
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main" style="background-color :azure">
    <div class="row">
        <ol class="breadcrumb">
            <li><a href="#">
            ...
            <form role="form" id="booking" data-toggle="validator">
                ...
                <div class="col-lg-12">
                    ...
                    if (isset($_GET['room_id'])){?>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Room Information:
                                <a class="btn btn-secondary pull-right" href="indexUser.php?room_mangUser">Replan Booking</a>
                            </div>
                    ...
                    <?php } else{?>
                        <div class="panel panel-default">
                            <div class="panel-heading">Room Information:
                                <a class="btn btn-secondary pull-right" style="border-radius:0%" href="indexUser.php?reservationUser">Replan Booking</a>
                            </div>
                            <div class="panel-body">
                                <div class="form-group col-lg-6">
                                    <label>Room Type</label>
    ...
    <div class="row">
        <div class="col-sm-12">
            <p class="back-link">Aku lah Sang Prabu</p>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class="btn btn-primary" style="border-radius:60px;" href="indexUser.php?reservationUser"><i class="fa fa-check-circle"></i></a>
            </div>
        </div>
